...
know_list = ["", 'Iniziative', 'Volantinaggio', 'Passaparola', 'Altro']
...
variables_list = ["data_inserimento", "nome", "cognome", "età", "sesso_genere", "indirizzo",
                  ...
                  "conoscenza_sportello_altro", "descrizione_problema_accesso", "problema_accesso", 
                  "problema_di_accesso_altro",  "prestazione_richiesta", "codice_prestazione", 
                  "azioni_intraprese", "ente_coinvolto", "ente_coinvolto_altro", 
                  "struttura_coinvolta", "documentazione", "riscontro", "note_riscontro", 
                  "data_riscontro" ]
